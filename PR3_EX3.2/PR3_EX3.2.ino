...
void loop() 
{
 ...
 delay(POT);  // Temps (ms)
  ...
  digitalWrite(LED0, HIGH);  //Sortida  digital ON
  digitalWrite(LED1, HIGH);  //Sortida  digital ON
  digitalWrite(LED2, HIGH);  //Sortida  digital OFF
  digitalWrite(LED3, LOW);  //Sortida  digital OFF
  digitalWrite(LED4, LOW);  //Sortida  digital OFF
  digitalWrite(LED5, LOW); //Sortida  digital OFF
  digitalWrite(LED6, LOW); //Sortida  digital OFF
  ...
  digitalWrite(LED0, LOW);  //Sortida  digital ON
  digitalWrite(LED1, HIGH);  //Sortida  digital ON
  digitalWrite(LED2, HIGH);  //Sortida  digital OFF
  digitalWrite(LED3, HIGH);  //Sortida  digital OFF
  digitalWrite(LED4, LOW);  //Sortida  digital OFF
  digitalWrite(LED5, LOW); //Sortida  digital OFF
  digitalWrite(LED6, LOW); //Sortida  digital OFF
  digitalWrite(LED7, LOW); //Sortida  digital OFF
  ...
  digitalWrite(LED0, LOW);  //Sortida  digital ON
  digitalWrite(LED1, LOW);  //Sortida  digital ON
  digitalWrite(LED2, HIGH);  //Sortida  digital OFF
  digitalWrite(LED3, HIGH);  //Sortida  digital OFF
  digitalWrite(LED4, HIGH);  //Sortida  digital OFF
  digitalWrite(LED5, LOW); //Sortida  digital OFF
  digitalWrite(LED6, LOW); //Sortida  digital OFF
  digitalWrite(LED7, LOW); //Sortida  digital OFF
  ...
  digitalWrite(LED3, HIGH);  //Sortida  digital OFF
  digitalWrite(LED4, HIGH);  //Sortida  digital OFF
  digitalWrite(LED5, HIGH); //Sortida  digital OFF
  digitalWrite(LED6, LOW); //Sortida  digital OFF
  digitalWrite(LED7, LOW); //Sortida  digital OFF
  ...
  digitalWrite(LED4, HIGH);  //Sortida  digital OFF
  digitalWrite(LED5, HIGH); //Sortida  digital OFF
  digitalWrite(LED6, HIGH); //Sortida  digital OFF
  digitalWrite(LED7, LOW); //Sortida  digital OFF
  ...
  digitalWrite(LED5, HIGH); //Sortida  digital OFF
  digitalWrite(LED6, HIGH); //Sortida  digital OFF
  digitalWrite(LED7, HIGH); //Sortida  digital OFF
  ...
  digitalWrite(LED5, HIGH); //Sortida  digital OFF
  digitalWrite(LED6, HIGH); //Sortida  digital OFF
  digitalWrite(LED7, HIGH); //Sortida  digital OF
